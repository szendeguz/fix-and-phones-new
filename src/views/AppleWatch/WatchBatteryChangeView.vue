<template>
    <sub-header headline="apple watch akkumulátor csere"></sub-header>
    <basic-section :headline="headline" :paragraph1="paragraph1" :paragraph2="paragraph2" :image="img"></basic-section>
    <mega-accordion-section contentType="watchBatteryChange" :priceList="watchBatteryList"></mega-accordion-section>
  ...
  export default {
    ...
    computed: {
      watchBatteryList() {
          return store.applewatchList.filter(watch => watch.batteryChange || watch.batteryChange === 0);
      }
    }
  }
  </script>
